package com.bamenyouxi.cow_nn_mode.config.SecurityConfig;

import com.bamenyouxi.core.constant.*;
import com.bamenyouxi.cow_nn_mode.mapper.mysql.cow_nn_mode.SysAgentMapper;
import com.bamenyouxi.cow_nn_mode.model.Spring.CustomUser;
...
abstract class AbstractCustomWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				.authorizeRequests()
				.antMatchers(WebConstant.PageUrl.notify_url, "/agent/notify", "/agent/notify.html").permitAll()
				.antMatchers(WebConstant.PageUrl.result_url, "/agent/result", "/agent/result.html").permitAll()
				.antMatchers(WebConstant.PageUrl.result_urls, "/Price/notify", "/Price/notify").permitAll()
				.antMatchers("/favicon.ico", "/bootstrap/**", "/img/**").permitAll()
