...
public final class DBConstant {
	...
	public static class InviteCodeMode {
		private final static String PACKAGE = ".invite_code_mode";
		public final static String DATASOURCE_NAME = "invite_code_mode";
		...
		public final static String XML_PATH = "classpath:/mapper/mysql/invite_code_mode/*.xml";
		public final static String PREFIX = "spring.datasource.mysql.invitecodemode";
